        ...
        <div className="about-us-heading-container flex items-start max-lg:items-center w-4/5 max-lg:w-[90%] my-8 max-sm:my-4">
          <div className="about-us-content w-2/3 max-lg:w-full">
            ...
            <p className="text w-3/4 max-lg:w-full py-4 font-['inter'] leading-7 max-sm:leading-5 text-justify ">
              ...
              officiis reprehenderit accusantium saepe! At magni totam,
              voluptatem facilis deleniti optio! Totam deserunt quos debitis
              voluptatum! Saepe nobis quia veniam officiis velit iure
              repudiandae ratione id, dolore debitis voluptas, porro, voluptatem
              ut consequuntur ab a. Explicabo dignissimos odio consequatur ipsum
              accusamus minus, nobis sapiente eum omnis velit tempora
              praesentium, optio voluptatibus necessitatibus reiciendis!
              Reprehenderit laborum veniam odit distinctio esse possimus
              consequuntur aperiam, suscipit delectus eius dolorem, nam
              necessitatibus corporis. Voluptatum ab perferendis velit,
              quibusdam culpa atque corrupti qui consequuntur dolor eaque, nam,
              quisquam maiores aspernatur quaerat repellat ut in incidunt et est
              obcaecati exercitationem possimus? Delectus corrupti distinctio
        ...
        <div className="key-values flex flex-col  w-[70%] max-lg:w-[80%] max-sm:w-[90%] my-4">
          ...
          <div className="flex py-2">
            <p>
              ...
              cities and towns of India including deep penetration in Tier II
              and III cities.
            </p>
          </div>
          <div className="py-2">
            <p>
              ...
              A vast range of features for a more engaging user experience with
              23 transaction oriented search plus verticals, JD Social –
              Justdial's own social sharing platform, and a Real Time Chat
                ...
                >
                  ...
                  >
                    ...
                    <Accordion.Panel>
                      ...
                      you email Id, you will recieve a link on your mail to
                      reset your password.
                    </Accordion.Panel>
                  </Accordion.Item>
                  ...
                  <Accordion.Item className={classes.item} value="add-business">
                    ...
                    <Accordion.Panel>
                      ...
                      located on the homepage. Fill in the required details
                      about your business and submit it for approval. Once
                      approved, your business will be listed on the platform.
                    </Accordion.Panel>
                  </Accordion.Item>
                  ...
                  >
                    ...
                    <Accordion.Panel>
                      ...
                      categories like grocery, food, electronics, fashion,
                      books, and home. This will help users find your business
                      easily.
                    </Accordion.Panel>
                  </Accordion.Item>
                </Accordion>
