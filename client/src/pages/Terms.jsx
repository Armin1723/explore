    ...
    <div className="w-screen flex flex-col items-center mt-[10vh] bg-secondary font-['Inter']">
      ...
      <div className="content-container flex flex-col w-full px-[10%] max-lg:px-[5%] max-sm:px-6 py-6 text-justify">
        ...
        <p className="">
          ...
          information/data and sensitive personal data (hereinafter collectively
          referred to as “information”) of the users of the site. All the users
          must read and understand this Privacy Policy as it has been formulated
          to safeguard the user’s privacy. This Privacy Policy also outlines the
          ways the users can ensure protection of their personal identifiable
          information. You must accept the contents of this Policy in order to
          use or continue using our site. This Privacy Policy detailed herein is
          also applicable to user of the site or mobile application through
        ...
        <div className="w-full">
          ...
          <ul className="list-disc list-inside text-justify md:w-3/4 pl-4">
            <li>
              ...
              information which may also include business statutory details and
            ...
            <li>
              ...
              (including the additional information, if any) in relation to the
              services for quality control or training purposes.
            </li>
            <li>
              {" "}
            ...
            <li>
              ...
              for facilitating the users in its business. We retains user
            ...
            <li>
              These data points may be captured by regulated financial entities
              through secure integration from your desktop, mobile and other
              such devices by analyzing transactional SMS, installed app
              details, queries, device location, device information, IMEI
              number, serial number, MNC and MCC codes, RAM storage, WIFI
              information etc. We also avail of the class called AccountManager
              from the Google SDK which allows us to fetch social account
              related details.{" "}
            </li>
            <li>
              ...
              This allows us to pre-fill Your verified e-mail ID details so that
              we can offer You a seamless and convenient user experience. You
              can always edit such pre-filled e-mail ID from your user profile.{" "}
            </li>
          </ul>
          ...
          customercare@indiamart.com. The requested changes may take reasonable
          time due to verification process and server cache policies. In case
          you would like to receive a copy of our information held by us for
          porting to another service, please contact us with your request at the
          email address above. Users may also choose to delete or deactivate
          their accounts on the site. We will evaluate such requests on a
          case-to-case basis and take the requisite action as per applicable
          law. In this regard, please note that information sought to be deleted
          may remain with us in archival records for the purpose of compliance
          of statutory enactments, or for any other lawful purpose. Therefore,
          users are requested to carefully evaluate what types of information
          they would like to provide to us at the time of registration.
        </div>
        ...
        <div className="w-full">
          ...
          your use of the site and track your visits to third party websites. We
          also use cookies to recognize your browser software and to provide
          features such as recommendations and personalization. Third parties
          whose products or services are accessible or advertised through the
          site, including social media sites, may also use cookies or similar
          tools, and we advise you to check their privacy policies for
          information about their cookies and the practices followed by them. We
          do not control the practices of third parties and their privacy
        ...
        <div className="w-full">
          ...
          such Personally Identifiable Information. If we become aware that a
          person submitting personal information is under 18, we will delete the
          account and all related information as soon as possible. . If you
          believe we might have any information from or about a child under 18
          please contact us at customercare@indiamart.com
        </div>
        ...
        <div className="w-full">
          ...
          personal data, you agree to such transfers. Your Personal Information
          may be transferred to countries that do not have the same data
          protection laws as the country in which you initially provided the
          information. When we transfer or disclose your Personal Information to
          other countries, we will protect that information as described in this
          Privacy Policy. relevant, we will ensure appropriate contractual
