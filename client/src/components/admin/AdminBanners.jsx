...
import { Button, Card, Image, Modal, ScrollArea } from "@mantine/core";
import { notifications } from "@mantine/notifications";
import { MdAdd, MdDelete, MdUndo } from "react-icons/md";
          ...
          >
            {banners.map((banner, index) => (
              <Carousel.Slide key={index}>
                ...
                <div
                  onClick={open}
                  className="absolute z-20 top-0 right-6 translate-y-1/2 p-2 rounded-full bg-gray-100/50 hover:bg-gray-300 transition-all duration-300 cursor-pointer border border-gray-500 shadow-lg"
                >
                  <MdDelete />
                </div>
